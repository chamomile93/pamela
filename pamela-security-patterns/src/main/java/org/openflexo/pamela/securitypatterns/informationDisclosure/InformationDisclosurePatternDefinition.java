...
/**
 * Represents an occurence of an <code>Information Disclosure Pattern</code>. An instance is uniquely identified by the <code>patternID</code> field of associated annotations.<br>
 * 
 * It has the responsibility of:
 * <ul>
 * <li>Managing life-cycle of {@link InformationDisclosureInstance}, while beeing notified from the creation of new instances by the
 ...
 *
 */
public class InformationDisclosurePatternDefinition extends PatternDefinition {
	...
	public InformationDisclosurePatternDefinition(String identifier, PamelaMetaModel pamelaMetaModel) {
