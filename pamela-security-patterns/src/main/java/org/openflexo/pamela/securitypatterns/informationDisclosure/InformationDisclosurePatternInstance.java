...
package org.openflexo.pamela.securitypatterns.informationDisclosure;
...
/**
 * Represent an instance of a given {@link InformationDisclosurePatternDefinition}
 * 
 * It has the responsibility of:
 * <ul>
 * <li>Maintaining state variables of the pattern instance</li>
 * <li>Enforcing invariants of the {@link Component} annotated class.</li>
 * <li>Enforcing preconditions of the {@link Component} annotated class.</li>
 * <li>Enforcing postconditions of the {@link Component} annotated class.</li>
 * </ul>
 *
 * @author camomille, Caine Silva, Sylvain Guerin
 */
public class InformationDisclosure<A, S, AI, PI> extends PatternInstance<InformationDisclosurePatternDefinition>
	...
	public InformationDisclosure(InformationDisclosurePatternDefinition patternDefinition, S subject) {
		super(patternDefinition);
		this.subject = subject;
		registerStakeHolder(subject, InformationDisclosurePatternDefinition.SUBJECT_ROLE);
		try {
	...
	private void checkAuthenticator() {
		...
		try {
			...
			if (authenticator == null && retrievedAuthenticator != null) {
				...
				registerStakeHolder(authenticator, InformationDisclosurePatternDefinition.AUTHENTICATOR_ROLE);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	void checkAfterInvoke(Object instance, Method method, Object returnValue, Object[] args)
		...
		if (isValid()) {
			...
			} finally {	// TODO: multiple AuthInfo
	...
	private void checkAuthInfoUniqueness() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		if (currentAuthInfo != null) {
			for (PatternInstance<InformationDisclosurePatternDefinition> pi : getModelContext().getPatternInstances(getPatternDefinition())) {
				InformationDisclosure otherInstance = (InformationDisclosure) pi;
