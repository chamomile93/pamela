...
/**
 * Represent the factory for {@link InformationDisclosurePatternDefinition}
 * 
 * @author camomille, Caine Silva, Sylvain Guerin
 */
public class InformationDisclosurePatternFactory extends AbstractPatternFactory<InformationDisclosurePatternDefinition> {

	public InformationDisclosurePatternFactory(PamelaMetaModel pamelaMetaModel) {
